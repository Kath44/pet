...
(24, 1, NULL, 'Added new pet owner: Gary Larson', '2024-12-10 13:01:21'),
(25, 1, NULL, 'Add new pet_type_name: do', '2024-12-10 13:02:41'),
(26, 1, NULL, 'Updated pet_type_name: do to dog', '2024-12-10 13:02:44'),
(27, 1, NULL, 'Add new pet_type_name: dragon', '2024-12-10 13:02:50'),
(28, 1, NULL, 'Added new pet owner: rhona', '2024-12-10 13:05:31'),
(29, 1, NULL, 'Added new pet owner: katlin', '2024-12-10 13:06:14'),
(30, 1, NULL, 'Add new pet_type_name: dinosaur', '2024-12-10 13:08:03'),
(31, 1, NULL, 'Added new pet: Yoshio Mcconnell', '2024-12-10 13:10:31'),
(32, 1, NULL, 'Added new pet: Cameran Elliott', '2024-12-10 13:16:13'),
(33, 1, NULL, 'Updated pet: test1x to test1x, Health: Healthy to Healthy, Vaccination: Vaccinated to Vaccinated', '2024-12-10 13:25:59'),
(34, 1, NULL, 'Updated pet: Yoshio Mcconnell to Yoshio Mcconnell, Health: Healthy to Healthy, Vaccination: Not Vaccinated to Not Vaccinated', '2024-12-10 13:26:06'),
(35, 1, 'delete', 'Deleted adopter: testa', '2024-12-10 13:26:42'),
(36, 1, NULL, 'Added new adopter: vince', '2024-12-10 13:46:01'),
(37, 1, NULL, 'Added new adopter: Rhiannon Clements', '2024-12-10 14:34:16'),
(38, 1, NULL, 'Added new adopter: ronald', '2024-12-10 14:34:30'),
(39, 1, NULL, 'Added new adopter: andie', '2024-12-10 14:34:46'),
(40, 1, NULL, 'Updated pet: Cameran Elliott to Cameran Elliott, Health: Healthy to Healthy, Vaccination: Not Vaccinated to Not Vaccinated', '2024-12-10 14:53:50'),
(41, 1, NULL, 'Added new pet: Garth Mcbride', '2024-12-10 20:14:54'),
(42, 1, NULL, 'Added new pet: Elliott Ayers', '2024-12-10 20:15:11'),
(43, 1, NULL, 'Added new pet: Jane Fry', '2024-12-10 20:15:27');
...
(2, 'vince', '09166748902', 'vince@gmail.com', 'hasdasdhakhsdkhaksh', 'vince.jpg', 'asd', '$2y$10$/Njbu7OlahVkKl5YLrw36eW4MYc.FoQXXcoCkO6Gj45YviXi17eMi'),
(3, 'Rhiannon Clements', '389', 'gixax@mailinator.com', 'Dicta id nostrum ali', 'Rhiannon Clements.jpg', 'tibimox', '$2y$10$2Isd/XwsuMYgthz7/x3Iw.znJSYHn9OH5BaHvjyLIlYa1I5ZkSiU6'),
(4, 'ronald', '828', 'sowodagax@mailinator.com', 'Sit recusandae Duci', 'ronald.jpg', 'ridorori', '$2y$10$3z5f6TWyQL3wkNnD7Xayz.72Y3lUan74KSdMwK/jKCcedJ7CydLeO'),
(5, 'andie', '362', 'myxypujap@mailinator.com', 'Expedita labore recu', 'andie.jpg', 'ryjufux', '$2y$10$eQvWORT3EmNnL60gvisSfOkd.67Q5oM.QoypGSLyHmyFuuinHJxlS');
...
(1, 'pexels-pixabay-257540.jpg', 'Pet Adoption', 'Minglanilla, Cebu', '09123456789', 'https://youtu.be/X_8d5mNXPJE?si=lprzHrPYbaAAXYG4');
...
(1, 1, 'test1x', 1, 'testx11', 51, 'Female', 'Healthy', 'pet adoption system.docx', 'Vaccinated', 'course_outline_c#.docx', 'Adopted', 'test.png', '2024-12-10'),
(3, 5, 'Yoshio Mcconnell', 5, 'palihug kog atiman ani nga iro please thank you', 2012, 'Male', 'Healthy', 'pexels-chevanon-photography-1108099.jpg', 'Not Vaccinated', '798344-cute-baby-animal-dogs.jpg', 'Adopted', 'Yoshio Mcconnell.jpg', '2024-12-10'),
(4, 3, 'Cameran Elliott', 1, 'Modi aut eveniet de', 2011, 'Male', 'Healthy', 'pexels-pixabay-257540.jpg', 'Not Vaccinated', 'pexels-chevanon-photography-1108099.jpg', 'Available', 'Cameran Elliott.jpg', '2024-12-10'),
(5, 4, 'Garth Mcbride', 4, 'Voluptatem natus ut', 2007, 'Female', 'Needs Treatment', '8de41f44d4f422b21b503d7bb1f298ce.jpg', 'Not Vaccinated', '0733ba760b29378474dea0fdbcb97107.jpg', 'Pending', 'Garth Mcbride.jpg', '2024-12-10'),
(6, 4, 'Elliott Ayers', 1, 'Ipsum quis sed blan', 1987, 'Male', 'Healthy', 'template_0.jpg', 'Not Vaccinated', '0733ba760b29378474dea0fdbcb97107.jpg', 'Adopted', 'Elliott Ayers.jpg', '2024-12-10'),
(7, 1, 'Jane Fry', 4, 'Non sint ea sit en', 1993, 'Male', 'Needs Treatment', 'th.jpg', 'Not Vaccinated', 'th.jpg', 'Adopted', 'Jane Fry.jpg', '2024-12-10');
...
(3, 'Gary Larson', '57', 'tyruw@mailinator.com', 'Nostrum dolorum sint', 'Gary Larson.jpg', 'keqeve', '$2y$10$K6BjqjdUmbpX3LGHPBW2w.PBqWK42ntaC6P4vA5IMIkPeG8WYDwxe'),
(4, 'rhona', '394', 'zonifi@mailinator.com', 'Aliquid voluptatem a', 'rhona.jpg', 'wylyt', '$2y$10$nHQEiF.Pird12Dwtdmgbbe.NoInt/QSy9bwQRG6BupEt3AfXOBC.u'),
(5, 'katlin', '584', 'tocapalazu@mailinator.com', 'Autem duis quae vero', 'katlin.jpg', 'mavyte', '$2y$10$1lLY9mlLNUFUo0Z873PICOS2X9ivwt2lNilmPlIBkWnJZqpKXXrEO');
...
(1, 'katlin', '$2y$10$EAEjLOviQu5KiQ.iidxqiOUHBnyu/rOGERc0JEOMwxqCXNPRLmNkq', 'Administrator', 'have all access', '8de41f44d4f422b21b503d7bb1f298ce.jpg', 'admin');
...
--
ALTER TABLE `tbl_activity_log`
  MODIFY `log_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `tbl_pet_type`
  MODIFY `pet_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
